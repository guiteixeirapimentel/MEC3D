...
{
    //Timer t;
    //auto t1 = t.SetTimer("teste");
    //constexpr size_t n = 100000000;
    //float* x = new float[n];
    //t.Tick(t1);
    //for (size_t i = 0; i < n; i++)
    //{
    //    x[i] = float(i) * 3.547f; //sqrtf(float(i));
    //}
    //t.Tock(t1);
    //t.WriteToCoutAllTickTock();
    //t.Tick(t1);
    //for (size_t i = 0; i < n; i++)
    //{
    //    x[i] = float(i) / (float(i) + 2.34f); //sqrtf(float(i));
    //}
    //t.Tock(t1);
    //t.WriteToCoutAllTickTock();
    //t.Tick(t1);
    //for (size_t i = 0; i < n; i++)
    //{
    //    x[i] = float(i) + 2.0f; //sqrtf(float(i));
    //}
    //t.Tock(t1);
    //t.WriteToCoutAllTickTock();
    ...
    constexpr double E = 1.0;//300.0;// 1.0; //200.0;
    constexpr double v = 0.25;//0.3;// 0.25;//0.3;  
    ...
    ElementoCte(malhaQ, E, v);
    	
	TriangularMeshWindow dispWndQ(800, 600, L"Visualizar malha", malhaQ.GetMeshAsDataPoints());
